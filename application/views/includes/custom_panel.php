	...
	<div class="customizer-body">
		<ul class="nav customizer-tab" role="tablist">
			...
			<li class="nav-item col-md-6">
				<a class="nav-link active" id="pills-profile-tab4" data-toggle="pill" href="#chat" role="tab" aria-controls="chat" aria-selected="false">
					<!--<i class="mdi mdi-message-reply font-20"></i>-->Receivables
				</a>
			</li>
			<li class="nav-item col-md-6">
				<a class="nav-link" id="pills-contact-tab4" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact"
					aria-selected="false">
					<!--<i class="mdi mdi-star-circle font-20"></i>-->Payables
				</a>
			</li>
		</ul>
		<div class="tab-content" id="pills-tabContent4">
			<!-- Tab 1 -->
			<div class="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab4">
			...
			<!-- End Tab 1 -->
			<!-- Tab 2 -->
			<div class="tab-pane fade show active" id="chat" role="tabpanel" aria-labelledby="pills-profile-tab4">
			...
			<div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab4">
				...
				<div class="steamline">
					...
					<div class="sl-item">
						<div class="sl-left">
							<img class="rounded-circle" alt="user" src="<?=base_url()?>/assets/images/users/user_default.png"> </div>
						<div class="sl-right">
