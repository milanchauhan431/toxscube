...
var chart = new Chartist.Line('.ct-animation-chart', {
  ...
  showArea: true,
  plugins: [
      Chartist.plugins.legend({ position : legendDiv })
  ]
});
...
new Chartist.Bar('.cd-db', {
  labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
  series: [
    [800000, 1200000, 1400000, 1300000,800000, 1200000, 1400000, 1300000,800000, 1200000, 1300000,800000],
    [200000, 400000, 500000, 300000, 400000, 500000, 200000, 400000, 500000, 300000, 400000, 500000,]
  ]
}, {
  stackBars: true,
  axisY: {
